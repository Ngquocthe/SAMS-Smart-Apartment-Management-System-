...
<#assign xKeycloakify={
    ...
    "ftlTemplateFileName": "webauthn-authenticate.ftl",
    "themeType": "login",
    "themeName": "keycloakify-starter",
    "keycloakifyVersion": "11.9.6",
    "themeVersion": "0.0.0",
    "resourcesPath": ""
}>
...
<#function toJsDeclarationString object path>
    ...
    <#if isMethod>
        ...
        <#assign fieldNames = ["firstName", "lastName", "email", "username", "password", "password-confirm", "global", "totp", "userLabel", "recoveryCodeInput", "termsAccepted", "buildingSchema"]>
...
<base href="${xKeycloakify.resourcesPath}/dist/">
        <meta charset="utf-8">
        <meta name="viewport" content="width=device-width, initial-scale=1">

        <link rel="icon" type="image/png" sizes="32x32" href="${xKeycloakify.resourcesPath}/dist/favicon-32x32.png">
      <script type="module" crossorigin="" src="${xKeycloakify.resourcesPath}/dist/assets/index-p9bcGhxQ.js"></script>
    </head>
